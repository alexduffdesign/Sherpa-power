...
class MainChatbotElement extends HTMLElement {
  constructor() {
    ...
    // Extract config from attributes or define default config
    const apiEndpoint =
      this.getAttribute("api-endpoint") || "https://your-default-endpoint";
    const config = {
    ...
    // Create an internal ChatbotBase instance
