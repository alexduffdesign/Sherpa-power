import{p as d}from"./markdown-util.DadijVe3.js";import{S as c}from"./streaming-markdown-parser.Bd3zPGns.js";function h(a,t,e=2){return new Promise(s=>{let n=0;a.textContent="";let o=performance.now();const i=r=>{r-o>=e&&n<t.length&&(a.textContent+=t[n],n++,o=r),n<t.length?requestAnimationFrame(i):s()};requestAnimationFrame(i)})}async function l(a,t,e=2){const s=document.createElement("div");s.innerHTML=t,a.innerHTML="";for(const n of s.childNodes)if(n.nodeType===Node.TEXT_NODE){if(n.textContent.trim()){const o=document.createElement("span");a.appendChild(o),await h(o,n.textContent,e)}}else if(n.nodeType===Node.ELEMENT_NODE){const o=n.cloneNode(!1);a.appendChild(o),await l(o,n.innerHTML,e)}}class m extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._eventBus=null}set eventBus(t){this._eventBus=t}connectedCallback(){const t=this.getAttribute("label"),e=this.getAttribute("payload");this.render(t,e)}render(t,e){this.shadowRoot.innerHTML=`
      <style>
        .button {
...
//# sourceMappingURL=chatbot-components.Dw8RIxeb.js.map
