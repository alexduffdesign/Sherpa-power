import{m as u}from"./marked.esm.DtrQ3Nt4.js";function h(d){if(!d)return"";let n=d.replace(/([^\n])(#+ )/g,`$1
$2`).replace(/([^\n])([-*+] )/g,`$1
$2`).replace(/([^\n])(\d+\. )/g,`$1
$2`).replace(/(#+) /g,`
$1 `).replace(/\n\s*\n/g,`

`).trim();return u.parse(n)}class p extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._eventBus=null}set eventBus(n){this._eventBus=n}connectedCallback(){const n=this.getAttribute("label"),t=this.getAttribute("payload");this.render(n,t)}render(n,t){this.shadowRoot.innerHTML=`
      <style>
        .button-container {
          display: flex;
          flex-wrap: wrap;
...
//# sourceMappingURL=chatbot-components.DAbwduzR.js.map
