import{m as c}from"./marked.esm.DtrQ3Nt4.js";function d(l){return l?c.parse(l):""}class u extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._eventBus=null}set eventBus(t){this._eventBus=t}connectedCallback(){const t=this.getAttribute("label"),e=this.getAttribute("payload");this.render(t,e)}render(t,e){this.shadowRoot.innerHTML=`
    ...
    `,this.shadowRoot.querySelector(".button").addEventListener("click",()=>{if(!this._eventBus){console.error("No eventBus assigned to ButtonComponent");return}try{const s=JSON.parse(e);this._eventBus.emit("buttonClicked",s)}catch(s){console.error("Error parsing button payload:",s)}})}}class h extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.content="",this.animationInterval=null,this.defaultAnimationSpeed=30,this.currentAnimationSpeed=this.defaultAnimationSpeed,this.shouldAnimate=!0}connectedCallback(){const t=this.getAttribute("sender"),e=this.getAttribute("content")||"";this.content=e;const s=this.getAttribute("data-animate");this.shouldAnimate=s!=="false";const n=this.getAttribute("data-animation-speed");if(n){const o=parseInt(n,10);isNaN(o)||(this.currentAnimationSpeed=o)}else this.currentAnimationSpeed=this.defaultAnimationSpeed;this.render(t,this.content)}appendContent(t){this.content+=t,this.shouldAnimate?this.animateContent(t):this.updateContent(this.content)}updateContent(t){this.content=t;const e=this.shadowRoot.querySelector(".message__content");e&&(e.innerHTML=d(t))}render(t,e){const s=t==="assistant";this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
          width: 100%;
...
//# sourceMappingURL=chatbot-components.BBMy1C2S.js.map
