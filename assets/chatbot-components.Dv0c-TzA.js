import{p as l}from"./markdown-util.gcjemE0m.js";class c extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._eventBus=null}set eventBus(t){this._eventBus=t}connectedCallback(){const t=this.getAttribute("label"),e=this.getAttribute("payload");this.render(t,e)}render(t,e){this.shadowRoot.innerHTML=`
    ...
    `,this.shadowRoot.querySelector(".button").addEventListener("click",()=>{if(!this._eventBus){console.error("No eventBus assigned to ButtonComponent");return}try{const n=JSON.parse(e);this._eventBus.emit("buttonClicked",n)}catch(n){console.error("Error parsing button payload:",n)}})}}class u extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.content="",this.animationInterval=null,this.defaultAnimationSpeed=30,this.animationSpeed=this.defaultAnimationSpeed,this.shouldAnimate=!0}connectedCallback(){const t=this.getAttribute("sender"),e=this.getAttribute("content")||"";this.content=e;const n=this.getAttribute("data-animate");this.shouldAnimate=n!=="false";const i=this.getAttribute("data-animation-speed");if(i){const o=parseInt(i,10);isNaN(o)||(this.animationSpeed=o)}else this.animationSpeed=this.defaultAnimationSpeed;this.render(t,this.content)}appendContent(t){this.content+=t,this.shouldAnimate?this.animateContent(t):this.updateContent(this.content)}updateContent(t){this.content=t;const e=this.getAttribute("sender");this.render(e,this.content)}render(t,e){const n=t==="assistant";this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
          width: 100%;
