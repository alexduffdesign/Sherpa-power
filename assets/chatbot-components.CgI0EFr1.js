import{p as _}from"./markdown-util.DadijVe3.js";import{S as b}from"./streaming-markdown-parser.Bd3zPGns.js";function v(a,e,t=2){return new Promise(s=>{let n=0;a.textContent="";let i=performance.now();const o=r=>{r-i>=t&&n<e.length&&(a.textContent+=e[n],n++,i=r),n<e.length?requestAnimationFrame(o):s()};requestAnimationFrame(o)})}async function d(a,e,t=2){const s=document.createElement("div");s.innerHTML=e,a.innerHTML="";for(const n of s.childNodes)if(n.nodeType===Node.TEXT_NODE){if(n.textContent.trim()){const i=document.createElement("span");a.appendChild(i),await v(i,n.textContent,t)}}else if(n.nodeType===Node.ELEMENT_NODE){const i=n.cloneNode(!1);a.appendChild(i),await d(i,n.innerHTML,t)}}class x extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._eventBus=null}set eventBus(e){this._eventBus=e}connectedCallback(){const e=this.getAttribute("label"),t=this.getAttribute("payload");this.render(e,t)}render(e,t){this.shadowRoot.innerHTML=`
      <style>
        .button {
