import{p as d}from"./markdown-util.DadijVe3.js";import{S as c}from"./streaming-markdown-parser.Bd3zPGns.js";function h(o,t,e=5){return new Promise(s=>{let n=0;o.textContent="";let i=performance.now();const a=r=>{r-i>=e&&n<t.length&&(o.textContent+=t[n],n++,i=r),n<t.length?requestAnimationFrame(a):s()};requestAnimationFrame(a)})}async function l(o,t,e=2){const s=document.createElement("div");s.innerHTML=t,o.innerHTML="";for(const n of s.childNodes)if(n.nodeType===Node.TEXT_NODE){if(n.textContent.trim()){const i=document.createElement("span");o.appendChild(i),await h(i,n.textContent,e)}}else if(n.nodeType===Node.ELEMENT_NODE){const i=n.cloneNode(!1);o.appendChild(i),await l(i,n.innerHTML,e)}}class m extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._eventBus=null}set eventBus(t){this._eventBus=t}connectedCallback(){const t=this.getAttribute("label"),e=this.getAttribute("payload");this.render(t,e)}render(t,e){this.shadowRoot.innerHTML=`
      <style>
        .button {
